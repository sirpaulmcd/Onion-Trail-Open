...
/// updates the checkpoint respawn position in the GameSession and respawns
/// dead players.
/// </summary>
public class Checkpoint : MonoBehaviour
{
    ...
    /// <summary>
    /// Updates the checkpoint position in GameSession to match this 
    /// checkpoint. Heigh offset is used to ensure players do not spawn inside
    /// checkpoint GameObject.
    /// </summary>
    private void UpdateCheckpointPosition()
    {
        GameSession.instance.CheckpointPosition = this.transform.position + 
    ...
    /// <summary>
    /// Updates the GameSession checkpoint to match this checkpoint and
    /// teleports all living players to that location.
    /// </summary>
    private void UpdateCheckpointAndTeleport()
    {
        UpdateCheckpointPosition();
        PlayerManager.instance.TeleportLivingPlayersToCheckpoint();
    }
    #endregion
}
}