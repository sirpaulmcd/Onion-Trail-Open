...
public class PlayerHealth : Health
{
        ...
        set
        {
            ...
            if (newHealth != base.currentHealth)
            {
                ...
                if (IsOutOfHealth())
                {
                    ...
                    if (PlayerManager.instance.GetLivingPlayerCount() == 1) { base.IsDead = true; }
    ...
    protected override void ReactToDeath()
    {
        ...
        GameSession.instance.AttemptDecrementLives(1);
        InvokeDeathEvent();
    }
    ...
    private void IncapacitatePlayer()
    {
        ...
        if (PlayerManager.instance.AllIncapacitatedOrDead()) { PlayerManager.instance.KillAllPlayers(); }
    ...
    private void SendToLimbo()
    {
        ...
        this.gameObject.transform.position = GameSession.instance.LimboPosition;
    }

    /// <summary>
    /// Undoes limbo effects applied by SendToLimbo(). Teleportation back to
    /// map is handled by GameSession.
    /// </summary>
