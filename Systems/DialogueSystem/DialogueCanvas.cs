...
public class DialogueCanvas : MonoBehaviour
{
    ...
    /// </summary>
    public static DialogueCanvas instance = default;
    #endregion
    ...
    /// DialogueCanvas already exists, no more are created. Using 
    /// DontDestroyOnLoad, the DialogueCanvas instance can persist through 
    /// various scenes.
    /// </summary>
    private void SetUpSingleton()
    {
        if (DialogueCanvas.instance == null) 
        {
